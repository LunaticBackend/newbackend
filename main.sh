...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/LunaticBackend/newbackend/main/"
...
wget "http://raw.githubusercontent.com/LunaticBackend/newbackend/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
